...
// const allCodePoints = [];
// for (let i = 0; i < 65536; i++) allCodePoints[i] = i; // to be fixed!
...
const parts = [];
for (let i = 0; i < 819; i++) {// 820 will error
  // for (let i = 0; i < 1000000; i++) { // to be fixed
...
// test truncation of Number arguments to uint8
{
  ...
  // assert.strictEqual(buf.indexOf(0x697374657374), 0);// too large
